...
The showroom examples are static, synthetic/sanitized, and presentation-oriented. Tier 2 examples surface friction candidates; the Tier 3 example illustrates stronger mechanism-level attribution with enriched evidence. They are not generated by the public Action Preview.
