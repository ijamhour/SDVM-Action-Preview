...
For optional static examples showing sanitized PRE / POST / DELTA report narratives, see:

- [`showroom/index.html`](showroom/index.html) — visual gallery entry (recommended for browsing)
